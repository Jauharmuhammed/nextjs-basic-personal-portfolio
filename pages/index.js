...
export default function Home() {
  ...
  return (
    ...
    >
      <Head>
        <title>Jauhar Muhammed | Designer | Developer</title>
      ...
      <main>
        ...
        <div className="flex justify-between items-start">
          ...
          >
            ...
            <div className=" overflow-hidden">
              <m.h2 variants={item}>Develop</m.h2>
            </div>
            <div className=" overflow-hidden">
              <m.h2 variants={item}>Deploy</m.h2>
            </div>
          </m.div>
          <m.div
            variants={container}
            initial="hidden"
            animate="show"
            className="text-right lg:text-2xl text-base mt-auto"
          >
